...
const CertificateCard: React.FC<CertificateCardProps> = ({ name, imageUrl, certificateId, onClick }) => {
  return (
    <div className="bg-slate-900 shadow-lg grow rounded-lg bg-opacity-40 overflow-hidden m-4 " onClick={onClick}>
      <div className="px-4 py-2 flex flex-col w-full h-full">
        <h2 className="text-white text-base font-bold mb-2 xbg-black mr-2 xbg-opacity-75 px-2 py-1 rounded line-clamp-2">{name}</h2>
